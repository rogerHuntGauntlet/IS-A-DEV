...
document.addEventListener('DOMContentLoaded', function() {
    ...
    async function loadPosts(page = 1) {
        if (isLoading || !postsContainer || !loadingIndicator || !loadMoreBtn) return;
